    ...
    <>
      <div className="w-full h-64 relative px-4 overflow-hidden">
        <div className="w-full h-full relative">
          <img
            src="https://b.zmtcdn.com/data/pictures/0/18794830/97aacfec8ff0c93cd99bbb525e6400e7.jpg?output-format=webp&fit=around|771.75:416.25&crop=771.75:416.25;*,*"
            alt="Bar"
        ...
        <div className="absolute w-full left-8  bottom-2 text-white ">
          <h4 className="z-10">Live Sports Screening</h4>
